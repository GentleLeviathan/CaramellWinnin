namespace CaramellWinnin
{
    public struct Settings
    {
        ...
        public Settings(bool _AutoLoadMusic = true, string _MusicLink = "https://www.youtube.com/watch?v=V-KSyjmhwE0", bool _UseImage = false, int _ColorStep = 4, int _TimerInterval = 500)
        {
